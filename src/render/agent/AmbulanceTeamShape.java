...
public class AmbulanceTeamShape extends HumanShape {
	...
	public AmbulanceTeamShape(Entity entity, ScreenTransform transform,
	...
	public void drawShape(int count, int animationRate, PApplet applet,
		...
		if (this.action) {
			AgentAction
					.drawAmbulanceTeamAction(applet, super.moveX, super.moveY,
							super.markHeight, this.ambulanceAction, config);
