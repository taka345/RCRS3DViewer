...
public class FireBrigadeShape extends HumanShape {
	public FireBrigadeShape(Entity entity, ScreenTransform transform,
			int scale, PImage[] images) {
	...
	public void drawShape(int count, int animationRate, PApplet applet,
		...
		if (super.action) {
			AgentAction.drawFireBrigadeAction(applet, posX, posY, targetX,
					targetY, targetZ, config);
		}
