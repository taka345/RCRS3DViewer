...
public class BlockadeRender {
	...
	public void drawBlockade(PApplet applet, OBJLoader blockades, int[] apexes,
			int blockadeNum, float centerX, float centerY, float rotateY,
			int blockadeScale, int[] sideMaxApexes, ViewerConfig config) {
		...
		case ViewerConfig.HIGH:
			switch (blockadeNum) {
			case 1:
				blockades.draw(centerX, centerY, applet.PI / 2, rotateY, 0,
						blockadeScale);
				break;
			case 2:
