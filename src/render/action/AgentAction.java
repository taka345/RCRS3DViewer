...
public class AgentAction {
	public static void drawAmbulanceTeamAction(PApplet applet,
			int moveX,int moveY,
			float markHeight,PImage actionImage,ViewerConfig config) {
	...
	public static void drawCivilianAction(PApplet applet,
			int moveX,int moveY,float messageHeight,
			String sayMessage,ViewerConfig config) {
	  applet.pushStyle();
	...
	public static void drawFireBrigadeAction(PApplet applet,
			int posX,int posY,int
			targetX, int targetY,float targetZ,
            ViewerConfig config) {
	...
	public static void drawPoliceForceAction(PApplet applet,
			int moveX,int moveY,float markHeight,int 
			posX, int posY,
