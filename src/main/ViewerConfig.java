...
public class ViewerConfig extends PApplet {
	...
	public boolean checkMousePos(int x, int y, int width, int height) {
		if ((this.mouseX >= x && x + width >= this.mouseX)
				&& (this.mouseY >= y && y + height >= this.mouseY))
			return true;
		return false;
	}
