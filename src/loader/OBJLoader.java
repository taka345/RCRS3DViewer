...
public class OBJLoader {
	...
	public void draw(float x, float y, float rotateX, float rotateY,
	...
	void model_size(OBJModel model) {
		...
		PVector min = new PVector(applet.MAX_FLOAT, applet.MAX_FLOAT,
				applet.MAX_FLOAT);
		PVector max = new PVector(applet.MIN_FLOAT, applet.MIN_FLOAT,
				applet.MIN_FLOAT);
		PVector v;
